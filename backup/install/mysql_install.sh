...
#                       /____/            /____/
#
# 멀티 쉘 실행 : bash <(curl -f -L -sS http://shell.pe.kr/document/install/mysql_install.sh)
...
BOOST_DOWNLOAD_URL="https://sourceforge.net/projects/boost/files/boost/1.67.0/boost_1_67_0.tar.gz"


#-----------------------------------------------------------------------------------------------------------------------
MYSQL_VERSION="8.0.11"
MYSQL_DOWNLOAD_URL="https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-${MYSQL_VERSION}.tar.gz"
