...
#                       /____/            /____/
#
# 멀티 쉘 실행 : bash <(curl -f -L -sS http://shell.pe.kr/document/install/mariadb_10.1_install.sh)
...
#INSTALL_CONFIG="${INSTALL_CONFIG} -DDAEMON_NAME=mariadb"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DTOKUDB_OK=0"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_READLINE=1"
...
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_ARIA_STORAGE_ENGINE=1"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DUSE_ARIA_FOR_TMP_TABLES=1"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_XTRADB_STORAGE_ENGINE=1"
...
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_FEDERATEDX_STORAGE_ENGINE=1"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_PERFSCHEMA_STORAGE_ENGINE=1"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_QUERY_CACHE_INFO=1"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_QUERY_RESPONSE_TIME=1"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_SAFEMALLOC=AUTO"
#INSTALL_CONFIG="${INSTALL_CONFIG} -DWITH_LOCALES=1"
INSTALL_CONFIG="-DCMAKE_INSTALL_PREFIX=${SERVER_HOME}/${PROGRAME_HOME}/${MARIADB_HOME}"
INSTALL_CONFIG="${INSTALL_CONFIG} -DCMAKE_BUILD_TYPE=Release"
...
printf "\e[00;32m|-------------------------------------------------------------------------\e[00m\n"
printf "\e[00;32m|   shell>\e[00m ${SERVER_HOME}/${MARIADB_ALIAS}/bin/mysql -u root\n"
printf "\e[00;32m|   mysql>\e[00m SET PASSWORD = PASSWORD('비밀번호');\n"
printf "\e[00;32m|   mysql>\e[00m FLUSH PRIVILEGES;\n"
printf "\e[00;32m|-------------------------------------------------------------------------\e[00m\n"
printf "\e[00;32m| ${MARIADB_HOME} install success...\e[00m\n"
printf "\e[00;32m|-------------------------------------------------------------------------\e[00m\n"
